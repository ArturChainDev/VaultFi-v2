    ...
    <div>
      <div className="flex flex-col">
        <div className="relative flex items-center justify-between z-30">
          <img className="logo-icon" src="assets/images/logo/vault_logo.png" alt="logo" width={"200px"} />
          <a
            aria-current="page"
            href="/"
          ...
          <div className="hidden md:flex">
            <div className="flex items-center gap-10">
              <a
                href="/#roadmap"
                className="text-sm text-gold hover:text-white whitespace-nowrap px-3 py-1 bg-white/20 rounded-md"
              >
                Growth Potential
              </a>
              <a
        ...
        <div className="flex md:hidden overflow-auto -mx-3 px-3 py-3 no-scrollbar">
          <div className="flex items-center gap-4">
            <a
              href="/staking"
              className="relative px-3 py-1 text-sm text-gold bg-white/20 hover:opacity-90 rounded-md"
            >

              Staking
              <div className="absolute top-0 right-0 -mt-1.5 -mr-1.5 flex">
                <span className="px-[3px] py-[2px] text-[10px] leading-none bg-black text-white/50 rounded">
            ...
            <a
              href="https://presale.hypeloot.com/whitepaper.pdf"
              target="_blank"
              className="text-sm text-white/50 hover:text-white whitespace-nowrap"
            >
