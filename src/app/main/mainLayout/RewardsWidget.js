...
export const RewardsWidget = () => {
    return (
        <div className="flex flex-col items-center md:flex-row md:justify-between my-28">
            <div className="flex items-center justify-center w-full">
                <img src="assets/images/background/Vault Twitter V1.png" className="w-full" />
            </div>
            <div className="flex flex-col gap-2.5 md:gap-5 mt-10">
                <h3 className="text-center text-3xl font-extrabold italic uppercase md:text-5xl md:text-left">
                    DAILY STAKING REWARDS
                </h3>
                <p className="text-md text-center font-medium text-white/90 md:text-left md:text-base md:max-w-[600px]">
