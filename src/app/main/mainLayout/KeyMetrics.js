    ...
    return (
        ...
        <div className="grid gap-2 grid-cols-2">
          <div className="rounded-[12px] p-4 border border-[var(--purple)] bg-[var(--purple)] flex flex-col gap-6">
            <img src="/bg/key_metrics_1.svg" alt="" width="24" />
            <div>
          ...
          <div className="rounded-[12px] p-4 border border-[var(--purple)] bg-[var(--purple)] flex flex-col gap-6">
            <img src="/bg/key_metrics_2.svg" alt="" width="24" />
            <div>
          ...
          <div className="rounded-[12px] p-4 border border-[var(--purple)] bg-[var(--purple)] flex flex-col gap-6">
            <img src="/bg/key_metrics_3.svg" alt="" width="24" />
            <div>
          ...
          <div className="rounded-[12px] p-4 border border-[var(--purple)] bg-[var(--purple)] flex flex-col gap-6">
            <img src="/bg/key_metrics_4.svg" alt="" width="24" />
            <div>
          ...
          <div className="rounded-[12px] p-4 border border-[var(--purple)] bg-[var(--purple)] flex flex-col gap-6">
            <img src="/bg/key_metrics_5.svg" alt="" width="24" />
            <div>
          ...
          <div className="rounded-[12px] p-4 border border-[var(--purple)] bg-[var(--purple)] flex flex-col gap-6">
            <img src="/bg/key_metrics_6.svg" alt="" width="24" />
            <div>
          ...
          <div className="rounded-[12px] p-4 border border-[var(--purple)] bg-[var(--purple)] flex flex-col gap-6">
            <img src="/bg/key_metrics_8.svg" alt="" width="24" />
            <div>
