    ...
    <div className="flex flex-col gap-5">
      <div className="flex flex-col items-center">
        ...
        <div className="flex flex-col gap-2.5 md:gap-5">
          ...
          <p className="text-md md:text-lg text-center font-medium text-white/90 md:text-base max-w-[850px]">
      ...
      <div className="flex flex-col gap-3 md:grid md:grid-cols-3 pt-5">
